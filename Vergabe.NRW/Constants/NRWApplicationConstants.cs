namespace Vergabe.NRW.Constants;

internal class NRWApplicationConstants
{
    //URL
    internal const string NoticeAdvancedSearchUrl = "https://www.evergabe.nrw.de/VMPCenter/company/announcements/categoryOverview.do?method=showCategoryOverview";
