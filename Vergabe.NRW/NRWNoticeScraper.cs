...
internal static class NRWNoticeScraper
{
    internal static IWebDriver? ChromeDriver { get; set; }
    internal static List<Notice> ScrapeAllNoticesToList(
        ...
        )
    {
        ...
        try
        {
            ...
            .VisibilityOfAllElementsLocatedBy(By.XPath(NRWApplicationConstants.XPathBrowsePagesText)));

            //Gets the string of total pages and converts it into an integer
            var totalPages = Convert.ToInt32(ChromeDriver!
                .FindElement(By.XPath(NRWApplicationConstants.XPathBrowsePagesText)).Text.Split()[3]);
            //Gets the number of total notices found and converts it into an integer
            var totalNoticesFound = Convert.ToInt32(ChromeDriver
                .FindElement(By.XPath(NRWApplicationConstants.XPathBrowsePagesText)).Text.Split()[6]);
    ...
    {
        var tableCells = ChromeDriver!.FindElements(By.XPath(NRWApplicationConstants.XPathNoticeTableCells));
